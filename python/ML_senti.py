...
# PalSent without any combination. 
...
print("Loading Sentiment Analysis data set :")
...
if opts.use_hashing:
    vectorizer = HashingVectorizer(stop_words='english', alternate_sign=False,analyzer = 'char_wb', ngram_range=(2,5),
                                   n_features=opts.n_features)
    X_train = vectorizer.transform(x_train)
else:
    vectorizer = TfidfVectorizer(sublinear_tf=True, max_df=0.5,analyzer = 'char_wb', ngram_range=(2,5),
                                 stop_words='english')
